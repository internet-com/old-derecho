...
public:
     ...
     * Once a member is failed, it will be removed from the members list in a
     * future view. */
    ...
    int nFailed;
    /** ID of the node that joined or departed since the prior view; null if
    ...
    /** When constructing a View piecemeal, call this after num_members has been
     * set. */
    void init_vectors();
    ...
    /** Returns a pointer to the (IP address of the) member who recently
     * departed,
