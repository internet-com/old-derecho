...
int main (int argc, char *argv[]) {
  ...
  derecho::ManagedGroup managed_group(GMS_PORT, node_addresses, node_rank, server_rank, buffer_size, derecho::CallbackSet{stability_callback, nullptr}, block_size);
